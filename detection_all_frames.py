...
def process_video_with_object_detection_all_frames(video_path, output_folder, model_ckpt, detection_threshold=0.4):
    """
    Process every frame of a video by applying an object detection model 
    and save frames with bounding boxes.

    Args:
        video_path (str): Path to the input video.
        output_folder (str): Path to save the processed frames with bounding boxes.
        model_ckpt (str): Checkpoint for the Hugging Face object detection model.
        detection_threshold (float): Detection confidence threshold.

    Returns:
        list: List of output file paths with bounding boxes.
    """
...
output_folder = "processed_allframes_testvid3"
model_ckpt = "yainage90/fashion-object-detection"
processed_frames = process_video_with_object_detection_all_frames(video_path, output_folder, model_ckpt)
