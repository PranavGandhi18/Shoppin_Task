...
def keyframe_based_frame_extraction(video_path, output_folder, max_frames=20):
    ...
    scene_manager.add_detector(ContentDetector(min_scene_len=3))
    video_manager.start()
...
output_folder = "keyframe_selected_frames_testvid1"
selected_frames = keyframe_based_frame_extraction(video_path, output_folder)   
